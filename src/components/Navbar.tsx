    ...
    <header className="w-full">
      <div className="flex justify-between items-center px-20 py-3">
        ...
        <div className=" z-10 flex items-center justify-start ">
          <Link href="/" className="flex max-w-[121px] items-center">
            <svg
            ...
            >
              <path
                className="animate-fade-in-scale-y"
              ...
              ></path>
              <path
                className="animate-fade-in-width delay-5"
              ...
              ></path>
              <path
                className="animate-fade-in-width delay-6"
                d="M108.031 0H112.568V18.0303H121.094V21.6364H108.031V0Z"
                fill="currentColor"
              ></path>
              <path
                className="animate-fade-in-width delay-7"
                clipRule="evenodd"
              ...
              ></path>
              <path
                className="animate-fade-in-width delay-8"
                clipRule="evenodd"
              ...
              ></path>
              <path
                className="animate-fade-in-width delay-9"
        ...
        <nav className="relative z-[1] hidden lg:flex items-center justify-center">
          <ul className="flex list-none justify-center items-center ">
            {[
              ...
              <li key={i}>
                <button className="inline-flex items-center rounded-md px-4 py-2 transition-colors hover:bg-gray-200">
                  {item}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                    fill="none"
                    className="ml-2 transition-transform duration-300 ease-in-out group-data-[state=open]:rotate-180"
                  >
                    <path
                      stroke="currentColor"
                      strokeWidth="1.5"
            ...
            <li>
              <Link
                href="/enterprise"
                className="flex items-center rounded-md px-4 py-2 hover:bg-gray-200"
              >
                Enterprise
              </Link>
            </li>
        ...
        {/* Right side buttons */}
        <div className="z-10 flex items-center justify-end gap-x-2">
          <Link
            href=""
            className="hidden lg:inline-flex items-center px-4 py-1 rounded-full hover:bg-gray-100 text-sm"
          >
            Log in
          </Link>
          <Link
            href=""
            className="inline-flex items-center px-3 py-1 rounded-full bg-black text-white hover:bg-gray-800 text-sm"
          >
            Sign up
          </Link>
          ...
          {/* Mobile menu button */}
          <button
            className="inline-flex items-center justify-center rounded-full w-10 h-10 lg:hidden"
      ...
      {/* Mobile Dropdown */}
      {mobileMenuOpen && (
        <div className="absolute top-full right-0 bg-white shadow-lg p-4 flex flex-col gap-y-2 lg:hidden">
